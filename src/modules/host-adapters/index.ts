...
export class OpencodeAdapter extends AdapterBase {
   ...
   * stay in sync with the YAML definition.  A short preamble still appears
   * before the steps to keep the file structure stable for downstream
   * tooling that scans the SKILL.md.
   *
   * @param files Array of command definitions.
