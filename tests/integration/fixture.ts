 ...
 */
export async function createMinimalProject(root: string): Promise<string> {
 ...
 */
async function writeTestConfig(adabDir: string): Promise<void> {
 ...
 * @param adabDir Absolute path to `adab/`.
 */
async function writeTestWikiPages(adabDir: string): Promise<void> {
  const charPage = `---
type: character
name: Mara
status: alive
 ...
 * @param adabDir Absolute path to `adab/`.
 */
async function writeTestManuscript(adabDir: string): Promise<void> {
 ...
 * @param adabDir Absolute path to `adab/`.
 */
async function writeTestIndexFiles(adabDir: string): Promise<void> {
