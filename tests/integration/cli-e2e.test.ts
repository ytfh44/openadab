...
describe('CLI end-to-end', () => {
  ...
  it('createProgram() returns a Commander Command with help text containing "Usage:"', () => {
    const program = createProgram();
    const helpText = program.helpInformation();
    expect(helpText).toContain('Usage:');
    expect(helpText).toContain('openadab');
  });

  it('createProgram() registers expected commands (init, status, sync)', () => {
    const program = createProgram();
